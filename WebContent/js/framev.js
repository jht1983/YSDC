...
yltMenuIco=ylt.menuIco={
	...
	doMainMenuChild:function(_strModCode,_strModName,_strUrl){	
		document.getElementById("trsyssecmenu").style.display="none";
		mainhomeframe.location=_strUrl;		
	},
	doTopSysMainMenu:function(_obj){
		var objTitle=document.getElementById("trmenucontainer");
		var objDiv=document.getElementById("divabsolvemenu");
		var objAng=document.getElementById("divabsolvemenuang");
		if(objDiv.style.display==""){
			objDiv.style.display="none";
			objAng.style.display="none";
		}else{
			objDiv.style.top=objTitle.offsetHeight+"px";
			objAng.style.top=(objTitle.offsetHeight-6)+"px";
			objDiv.style.display="";
			objAng.style.display="";
		}
	},
	clearPopMenu:function(){
		var objDiv=document.getElementById("divabsolvemenu");
		var objAng=document.getElementById("divabsolvemenuang");
		objDiv.style.display="none";
		objAng.style.display="none";
	...
	doTopMainMenu:function(_obj,_strModCode){
		...
		var strParModCode=strCurSelManiMenuId.substring(8);
		if(strParModCode==_strModCode&&document.getElementById("trsyssecmenu").style.display==""){
			document.getElementById("trsyssecmenu").style.display="none";
			return;
		}
		document.getElementById("menu"+strParModCode).className="topmenutab";
		_obj.className="selMenutab";
