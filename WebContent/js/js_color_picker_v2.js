	...
	function chooseColor()
	{
		...
		color_picker_div.style.display='none';
		desinermain.ylt.table.setAreStyle(iSysColorType,color_picker_form_field.value);
	}
	...
	function chooseColorSlider()
	{
		...
		color_picker_div.style.display='none';	
		desinermain.ylt.table.setStyle(6,color_picker_form_field.value);
	}
	...
	function viewRep(_strRepId,_obj){
		if(_obj.itype == "desiner"){
			_obj.itype="view";
			_obj.src="images/rep/desiner.gif";
			desinermain.location="RepView?srepcode="+_strRepId+"&sys_isparam=true";
		}else{
			_obj.itype="desiner";
			_obj.src="images/rep/view.gif";
			desinermain.location="DesinerMain?srepcode="+_strRepId;
		}
	}