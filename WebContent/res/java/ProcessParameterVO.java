...
public class ProcessParameterVO {
	private String runCode; //运行流水号
	private String runFlow; //运行版本号
	private String inpPkey; //输入的主键
	private String pKey;	//输出的主键
	private String branck;	//输入的组织
	private String spageCode;//输入的表单
	private static MantraUtil tool = new MantraUtil(); // 工具类
